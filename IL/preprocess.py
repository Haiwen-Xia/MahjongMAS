...
with open(r'C:\code\AI\Fundamentals of Artificial Intelligence\Majong\code\data\data.txt', encoding='UTF-8') as f:
    line = f.readline()
    while line:
        t = line.split()
        if len(t) == 0:
        ...
        if t[0] == 'Match':
            ...
            saveData()
        line = f.readline()
with open(r'C:\code\AI\Fundamentals of Artificial Intelligence\Majong\code\data\count.json', 'w') as f:
    json.dump(l, f)