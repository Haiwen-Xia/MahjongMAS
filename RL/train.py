...
CONFIG = {
    # Experiment Meta
    'experiment_name': "Normalized_reward_Entropy=-3e-3_model_pool_size=120_PPO_update_epoch=2_Add_ir_policy=0.15", # Use underscores or avoid special chars for dir names
    ...
    'entropy_coeff': -3e-3, # Coefficient for entropy bonus
